...
class DiatomicRDMFTFunctional : public helfem::rdmft::EnergyFunctional<void> {
public:
...
int main(int argc, char **argv) {
  ...
  if (use_rdmft) {
      ...
      auto functional = std::make_shared<DiatomicRDMFTFunctional<diatomic::basis::TwoDBasis>>(basis, H0, power, n_alpha_orb, xc_type);
